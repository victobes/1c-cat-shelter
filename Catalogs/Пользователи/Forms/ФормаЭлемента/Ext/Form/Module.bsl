...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////////
	НовыйЭлемент = ЭтаФорма.Элементы.Добавить("приют_ФизическоеЛицо", Тип("ПолеФормы"), Элементы.ГруппаДанныеШапки);
	НовыйЭлемент.Вид = ВидПоляФормы.ПолеВвода;
	НовыйЭлемент.Заголовок   = "Физическое лицо";
	НовыйЭлемент.ПутьКДанным = "Объект.приют_ФизическоеЛицо";
	
	НовыйЭлемент = ЭтаФорма.Элементы.Добавить("приют_Должность", Тип("ПолеФормы"), Элементы.ГруппаДанныеШапки);
	НовыйЭлемент.Вид = ВидПоляФормы.ПолеВвода;
	НовыйЭлемент.Заголовок   = "Должность";
	НовыйЭлемент.ПутьКДанным = "Объект.приют_Должность";
	/////////////////////////////////////////////////////////////////////////////////////////////////////
